...
METHOD:REQUEST
BEGIN:VEVENT
UID:${Date.now()}@codeswithrakib.com
DTSTAMP:${formatDate(new Date())}
DTSTART:${formatDate(startDate)}
DTEND:${formatDate(endDate)}
SUMMARY:${subject || "Meeting with Rakib Islam"}
DESCRIPTION:${message || "Scheduled meeting"}
LOCATION:${type === "Video Call" ? "Online Video Meeting" : type === "Phone Call" ? "Phone Call" : "In-Person Meeting"}
ORGANIZER;CN=Rakib Islam:mailto:codeswithrakib@gmail.com
...
export default function ContactPage() {
  ...
  const handleScheduleMeeting = useCallback(async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `meeting-with-rakib-${Date.now()}.ics`;
      ...
      await fetch("/api/email", {
        ...
        body: JSON.stringify({
          to: values.email,
          subject: "Meeting Scheduled with Rakib Islam",
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
              ...
              <div style="background-color: #f0fdfa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                ...
                ${values.subject ? `<p style="margin: 5px 0;"><strong>Subject:</strong> ${values.subject}</p>` : ""}
              </div>
                ...
                <p style="margin: 0; color: #64748b; font-size: 14px;">
                  ${
                    meetingType === "Video Call"
                      ? "The meeting link will be sent to you 24 hours before the scheduled time."
                      : meetingType === "Phone Call"
                        ? "I will call you at the scheduled time."
                        : "The meeting location details will be sent to you soon."
                  }
                </p>
              </div>
        ...
        body: JSON.stringify({
          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
              ...
              ${values.subject ? `<p><strong>Subject:</strong> ${values.subject}</p>` : ""}
          ...
          body: JSON.stringify({
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <p><strong>Email:</strong> ${values.email}</p>
                ${values.phone ? `<p><strong>Phone:</strong> ${values.phone}</p>` : ""}
                <p><strong>Preferred Contact:</strong> ${values.preferredContact}</p>
                <p><strong>How they heard about me:</strong> ${values.hearAbout}</p>
                ...
                <p><strong>Subscribe to newsletter:</strong> ${values.subscribe ? "Yes" : "No"}</p>
              </div>
            `,
          }),
        });
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
                ...
                <div style="background-color: #f0fdfa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                  ...
                  <p style="white-space: pre-wrap; background-color: #f8fafc; padding: 10px; border-radius: 4px;">${values.message}</p>
                </div>
                ...
                <div style="margin-bottom: 20px;">
                  ...
                  <ol style="padding-left: 20px; color: #334155;">
                    ...
                    <li>Check your email for my response</li>
                  </ol>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        copyToClipboard("codeswithrakib@gmail.com")
                      }
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                        Max file size: 5MB each. Total attachments: 10MB.
